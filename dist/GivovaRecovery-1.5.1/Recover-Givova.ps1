...
function Set-GivovaTaskReliability {
    # Keep the existing action/principal (and therefore the existing install and identity).
    # This desktop Agent needs an interactive logon, not a pre-logon SYSTEM launch.
